//
//  Digimon+CoreDataProperties.swift
//  DigimonAssignment
//
...
extension Digimon {
    ...
    @nonobjc public class func fetchRequest() -> NSFetchRequest<Digimon> {
        return NSFetchRequest<Digimon>(entityName: "Digimon")
    }
...
extension Digimon {
    ...
    @NSManaged public func addToDescriptions(_ value: Description)

    @objc(removeDescriptionsObject:)
    @NSManaged public func removeFromDescriptions(_ value: Description)
